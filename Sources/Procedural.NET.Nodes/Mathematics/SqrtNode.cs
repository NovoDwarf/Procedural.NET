...
public sealed class SqrtNode : UnaryNode
{
	public override string Key => NodeKeys.Sqrt;
	...
	protected override float Transform(float value, Func<string, float>? param = null) => MathF.Sqrt(Math.Max(0f, value));
}
