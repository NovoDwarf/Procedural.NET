...
public sealed class RoundNode : UnaryNode
{
	public override string Key => NodeKeys.Round;
	...
	protected override float Transform(float value, Func<string, float>? param = null) => MathF.Round(value);
}
