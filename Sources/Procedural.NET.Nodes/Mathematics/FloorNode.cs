...
public sealed class FloorNode : UnaryNode
{
	public override string Key => NodeKeys.Floor;
	...
	protected override float Transform(float value, Func<string, float>? param = null) => MathF.Floor(value);
}
