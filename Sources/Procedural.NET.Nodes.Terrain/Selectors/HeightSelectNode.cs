...
public sealed class HeightSelectNode : BaseNode, ISampledExecutor, IFieldExecutor
{
	public override string Key => NodeKeys.HeightSelect;
	public override string GroupKey => NodeGroupKeys.Filters;
	public override string SubgroupKey => NodeSubgroupKeys.Selectors;
	
	public override ColorF Color => new(0.72f, 0.58f, 0.34f);
	...
	[
		...
		new(ParameterKeys.Max, 0f, 1f, 0.01f, 0.75f,
			Category: ParameterCategory.Primary),
	...
	{
		var value = graph.RequireScalarInput(model, PortKeys.Source, context);
